...
import {
  ...
  QrCode, ShieldCheck, LogOut, Database, Menu, X, Sun, Moon, ScanSearch, Settings as SettingsIcon
} from 'lucide-react';
...
import BtkSorgu from './views/BtkSorgu';
...
const NAV = [
  ...
  { to: '/btk',       label: 'BTK IMEI',       icon: ScanSearch,      num: '06', roles: ['Admin', 'Kasiyer', 'Teknisyen'] },
  { to: '/users',     label: 'Personel',       icon: ShieldCheck,     num: '07', roles: ['Admin'] },
  { to: '/audit',     label: 'Sistem Logu',    icon: Database,        num: '08', roles: ['Admin'] },
  { to: '/settings',  label: 'Ayarlar',        icon: SettingsIcon,    num: '09', roles: ['Admin'] },
];
      ...
      <main className="flex-1 min-w-0">
        ...
        <div className="p-4 sm:p-6 lg:p-8 max-w-7xl">
          <Routes>
            ...
            <Route path="/btk" element={<BtkSorgu />} />
