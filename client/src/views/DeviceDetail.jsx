...
import BtkSorguModal from '../components/BtkSorguModal';
  ...
  return (
    <div className="space-y-6">
      ...
      <div className="grid grid-cols-2 sm:grid-cols-4 lg:grid-cols-8 gap-2">
        ...
        <button onClick={() => setShowBtk(true)}
          className="py-3 text-xs inline-flex items-center justify-center gap-2 border font-mono"
          style={{ borderColor: C.ok, color: C.ok, background: C.paperLite }}>
          <ShieldCheck size={14} /> BTK SORGU
        </button>
