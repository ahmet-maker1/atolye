// Atölye.co — Boş veritabanına tek admin ekler.
//
...
// (admin@atolye.co / admin) — production'da reddeder.
...
const adminEmail    = process.env.ADMIN_EMAIL?.trim() || (isProd ? null : 'admin@atolye.co');
...
console.log('🌱 Atölye seed başlıyor...');
db.exec(`
